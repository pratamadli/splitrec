...
export const translations = {
  id: {
    ...
    // OCR
    'purchases.choose_input': 'Cara input transaksi?',
    'purchases.input_manual': 'Input Manual',
    'purchases.input_manual_desc': 'Isi judul, total, dan item sendiri',
    'purchases.scan_receipt': 'Scan Struk',
    'purchases.scan_receipt_desc': 'Foto struk, item auto-terisi',
    'ocr.title': 'Scan Struk',
    'ocr.review_title': 'Review Struk',
    'ocr.upload_prompt': 'Foto atau pilih gambar struk',
    'ocr.upload_hint': 'JPG, PNG, WEBP — pastikan teks terbaca jelas',
    'ocr.processing': 'Memproses struk...',
    'ocr.items_detected': 'Item Terdeteksi ({count})',
    'ocr.no_items': 'Tidak ada item terdeteksi. Tambah manual di bawah.',
    'ocr.add_item_manual': '+ Tambah item manual',
    'ocr.add_consumer': '+ Tambah peserta',
    'ocr.charges_detected': 'Biaya Tambahan Terdeteksi',
    'ocr.save_items': 'Simpan {count} Item',
    'ocr.item_name_placeholder': 'Nama item',
    'ocr.error': 'Gagal memproses struk. Pastikan foto cukup terang dan teks terbaca.',
    'ocr.back': '← Kembali',
    'error.ocr': 'Gagal memproses struk',
  },
  en: {
    // Common
    ...
    // OCR
    'purchases.choose_input': 'How to input transaction?',
    'purchases.input_manual': 'Manual Input',
    'purchases.input_manual_desc': 'Fill title, total, and items yourself',
    'purchases.scan_receipt': 'Scan Receipt',
    'purchases.scan_receipt_desc': 'Photo receipt, items auto-filled',
    'ocr.title': 'Scan Receipt',
    'ocr.review_title': 'Review Receipt',
    'ocr.upload_prompt': 'Photo or upload receipt image',
    'ocr.upload_hint': 'JPG, PNG, WEBP — make sure text is clearly visible',
    'ocr.processing': 'Processing receipt...',
    'ocr.items_detected': 'Items Detected ({count})',
    'ocr.no_items': 'No items detected. Add manually below.',
    'ocr.add_item_manual': '+ Add item manually',
    'ocr.add_consumer': '+ Add participant',
    'ocr.charges_detected': 'Additional Charges Detected',
    'ocr.save_items': 'Save {count} Items',
    'ocr.item_name_placeholder': 'Item name',
    'ocr.error': 'Failed to process receipt. Make sure the photo is clear and well-lit.',
    'ocr.back': '← Back',
    'error.ocr': 'Failed to process receipt',
  },
} as const
